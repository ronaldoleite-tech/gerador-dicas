...
function mudarLoteria(novaLoteria) {
    ...
    // [ALTERAÇÃO AQUI] Sincroniza o seletor de resultados com o seletor principal
    ...
    // [ALTERAÇÃO AQUI] Chama carregarUltimosResultados, pois a loteria principal mudou
    carregarUltimosResultados(novaLoteria);
}

// [ALTERAÇÃO AQUI] NOVA FUNÇÃO para o seletor de resultados
...
// [ALTERAÇÃO AQUI] Event Listener para carregar os resultados iniciais
document.addEventListener('DOMContentLoaded', (event) => {
    // Garante que a loteriaAtual é definida pelo seletor principal ao carregar a página
    const seletorPrincipal = document.getElementById('loteria-select');
    if (seletorPrincipal) {
        loteriaAtual = seletorPrincipal.value; // Define a loteriaAtual baseada no valor inicial do seletor
        mudarLoteria(loteriaAtual); // Chama mudarLoteria para inicializar tudo, incluindo a sincronização dos resultados
    }
});
// [FIM DA ALTERAÇÃO]